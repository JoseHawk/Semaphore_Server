    ...
    public void run ()
    {
        ...
        boolean continuar=true;
         ...
         try{
                ...
                if(mensaje[0]==(byte)1 || mensaje[0]==(byte)4 || mensaje[0]==(byte)7 || mensaje[0]==(byte)10){
                    identificador=1;
                }
                
                if(mensaje[0]==(byte)2 || mensaje[0]==(byte)5 || mensaje[0]==(byte)8 || mensaje[0]==(byte)11){
                    identificador=2;
                }
                ...
                if(valor==999){ //Si vale 999, no tenemos semaforo para el recurso. Informar al cliente
                    ...
                    if((mensaje[0]==(byte)10 || mensaje[0]==(byte)11 || mensaje[0]==(byte)12 || mensaje[0]==(byte)7 || mensaje[0]==(byte)8 || mensaje[0]==(byte)9)&&continuar==true){  
                        ...
                        if(identificador==1){
                           salida.write((byte)20); 
                        }
                        
                        if(identificador==2){
                           salida.write((byte)21);
                        }
                    ...
                    if((mensaje[0]==(byte)1 || mensaje[0]==(byte)2 || mensaje[0]==(byte)3 || mensaje[0]==(byte)4 || mensaje[0]==(byte)5 || mensaje[0]==(byte)6)&&continuar==true){
                        ...
                        if(identificador==1){
                           salida.write((byte)23);
                        }
                        
                        if(identificador==2){
                           salida.write((byte)24);
                        }
                        ...
                        mensajeEnviado = new DataOutputStream(conexionEnvio.getOutputStream());
                        if(identificador==1){
                           mensajeEnviado.write((byte)23);
                        }
                        
                        if(identificador==2){
                           mensajeEnviado.write((byte)24);
                        }
                        conexionEnvio.close();
                        continuar=false;
                    }
